...
from apps.pdf_tools.views.remote_control import rc_create, rc_offer, rc_answer, rc_ice, rc_poll, rc_close, rc_cmd, rc_agent_poll, zayrodesk_sw, zayrodesk_icon
...
urlpatterns = [
    ...
    path('zayrodesk-sw.js',            zayrodesk_sw,       name='zayrodesk_sw'),
    path('zayrodesk-icon/<int:size>.png', zayrodesk_icon,  name='zayrodesk_icon'),
